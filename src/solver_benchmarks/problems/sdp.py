...
@register_problem("sdp/max_cut_small", tags=["sdp", "small"], description="Max-cut SDP relaxation (20 nodes)")
...
@register_problem("sdp/matrix_completion", tags=["sdp", "medium"], description="Low-rank matrix completion (30x30, 50% observed)")
